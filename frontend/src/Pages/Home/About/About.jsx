  ...
  return (
    ...
    <div className="about" style={{backgroundColor: backgroundC}}>
        ...
        <div className="content">
          ...
          <p>
            At this OLP, we believe in the power of education to transform lives. Our platform is designed to be a gateway to knowledge, offering a diverse range of courses and learning experiences for students.
